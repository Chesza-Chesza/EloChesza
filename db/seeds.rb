...
Round.create!([
  { date: '12-12-2021', number: 1, tournament_id: 1 },
  { date: '13-12-2021', number: 2, tournament_id: 1 },
  { date: '14-12-2021', number: 3, tournament_id: 1 }
])
...
Game.create!([
  { player1_id: 1, player2_id: 5, result: 1, won: 1, round_id: 1 },
  { player1_id: 2, player2_id: 6, result: 1, won: 1, round_id: 1 },
  { player1_id: 3, player2_id: 7, result: 1, won: 1, round_id: 1 },
  { player1_id: 4, player2_id: 8, result: 1, won: 1, round_id: 1 },
  { player1_id: 1, player2_id: 3, result: 1, won: 1, round_id: 2 },
  { player1_id: 2, player2_id: 4, result: 1, won: 1, round_id: 2 },
  { player1_id: 1, player2_id: 2, result: 1, won: 1, round_id: 3 }
])
